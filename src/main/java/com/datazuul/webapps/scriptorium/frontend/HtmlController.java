...
class HtmlController {
    ...
    public String getText(@PathVariable int index, @ModelAttribute("images") List<Path> images) throws
    ...
    @RequestMapping(value = {"/text/{index}"}, method = RequestMethod.POST)
    @ResponseStatus(value = HttpStatus.OK)
    public void saveText(@ModelAttribute("images") List<Path> images, @RequestParam String html, @PathVariable int index) throws IOException {
        Path filePathImage = images.get(index);
